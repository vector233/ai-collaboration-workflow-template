...
本 note 是知识库的人类可读项目主索引。AI agent 主入口仍是 [[CLAUDE]]。

---

## 项目快速定位

- **是什么**：{{PROJECT_DESCRIPTION}}
- **技术栈**：{{TECH_STACK}}
- **核心域名 / 端口**：见 [[01-overview/quick-reference]]
...
各子项目的实现细节查阅其自身的 `CLAUDE.md` 与 `zettelkasten/`。
...
| [[08-technical-designs/README]] | 技术方案入口 |
