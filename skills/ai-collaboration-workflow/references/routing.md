...
Create one `WORK-*` from `zettelkasten/00-governance/templates/work-item.md`. Keep approach, slices, validation, inline review, checkpoints, and experience candidates in that file. The bundled WORK helper may automate this edit but is not required.
