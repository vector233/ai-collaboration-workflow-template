...
- Keep the project positioning precise: this is a Zettelkasten-style, Obsidian-compatible Markdown vault/workflow template, not an Obsidian plugin.
...
```text
AI Collaboration Workflow Template is a Zettelkasten-style, Obsidian-compatible Markdown vault for long-running software projects built with AI coding agents.
```
...
```text
AI Collaboration Workflow Template: Zettelkasten-style vault for coding agents
```
